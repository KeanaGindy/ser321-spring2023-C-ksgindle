...
public class PicturePanel extends JPanel {
   ...
   * @throws InvalidCoordinateException - Invalid coordinate attempted
   */
  public void insertImageBytes(ByteArrayInputStream image, int row, int col) throws IOException, InvalidCoordinateException {
    ...
    if (row < 0 || col < 0 || 
      ...
      handleFirstImage(icon.getIconWidth(), icon.getIconHeight());
      // insert image
      Image imageGet = icon.getImage();
      Image newImage = imageGet.getScaledInstance(200, 200, java.awt.Image.SCALE_SMOOTH);
