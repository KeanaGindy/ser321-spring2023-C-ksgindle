...
public class Server {
   ...
   */
   ...
   /* 
    * 
    *  JSONObjects and Protocol for each option below.
    *
    *
    *
   */
        ...
        try {
          ...
          while (true) {
            ...
            if (message.has("selected")) {
              ...
              //Leaderboard Option
              if (mess.equals("l") && message.has("selected")) {
                ...
                //Creating leaderboard and checking for repeat players.
                String leaderboard = "";
